...
xcopy /qchky /-i extracted\modem\image\spss2p.mbn output\Subsystems\SPSS\spss%SOC%v2p.mbn
...
bash.exe -c "./pil-squasher/pil-squasher ./output/Subsystems/VENUS/qcvss%SOC%.mbn ./extracted/modem/image/venus.mdt"

mkdir output\Subsystems\ZAP

echo Converting GPU ZAP Shader Micro Code DSP Image...
xcopy /qchky /-i extracted\vendor\firmware\a640_zap.elf output\Subsystems\ZAP\qcdxkmsuc%SOC%.mbn
...
bash.exe -c "./pil-squasher/pil-squasher ./output/Subsystems/WDSP/qcwdsp%SOC%.mbn ./extracted/modem/image/cpe_9340.mdt"
...
REM TODO: Trim
echo Copying keymaster64 (n=keymaster64;p=8:c47728cf3e4489,61,82:6024,b4;s=96) QSEE Applet...
